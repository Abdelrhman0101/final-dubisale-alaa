...
class SearchCard2 extends StatefulWidget {
  ...
  @override
  State<SearchCard2> createState() => _SearchCard2State();
}

class _SearchCard2State extends State<SearchCard2> with FavoritesHelper {
