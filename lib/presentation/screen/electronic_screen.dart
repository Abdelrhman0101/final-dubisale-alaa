...
const Color KPrimaryColor = Color.fromRGBO(1, 84, 126, 1); // اللون الأساسي الموحد
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      IconButton(
                        icon: Icon(Icons.notifications_none, color: borderColor, size: 35.sp),
                        onPressed: () {},
                      ),
                    ],
                  ),
                ...
                Padding(
                  ...
                  child: CustomCategoryGrid(
                    ...
                    onCategoryPressed: (selectedCategory) {
                      ...
                      else { print('Route not found for $selectedCategory'); }
                    },
                  ),
                ),
                SizedBox(height: 2.h),
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                Expanded(
                                  child: Text(s.click_for_deals_elect,
